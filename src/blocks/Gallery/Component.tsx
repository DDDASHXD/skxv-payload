...
const galleries: Record<string, React.ComponentType<any>> = {
  ...
  GALLERY25: dynamic(() => import('@/blocks/Gallery/gallery25').then((mod) => mod.Gallery25)),
  GALLERY26: dynamic(() => import('@/blocks/Gallery/gallery26').then((mod) => mod.Gallery26)),
}
